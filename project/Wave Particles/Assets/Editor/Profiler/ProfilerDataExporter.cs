...
namespace ProfilerDataExporter
{
    public class ProfilerDataExporter : EditorWindow
    {
        ...
        {
            filePath = @"..\..\profiling\data\" + DateTime.Now.ToString("yyyyMMddHHmmss")
                            + ".json";
        ...
        private void ExportSelectedFunctionData()
        {
            ...
            var lastFrameIndex = ProfilerDriver.lastFrameIndex;
            filePath = @"..\..\profiling\data\" + DateTime.Now.ToString("yyyyMMddHHmmss")
                            + ProfilerDriver.selectedPropertyPath.Substring(ProfilerDriver.selectedPropertyPath.LastIndexOf("/") + 1)
                            + ".json";
